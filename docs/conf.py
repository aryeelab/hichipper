# -*- coding: utf-8 -*-
#
# hichipper documentation build configuration file
#
...
project = u'hichipper'
copyright = u'Caleb Lareau, Aryee Lab'
...
# of the sidebar.
html_logo = 'contents/media/hichipper_logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = 'contents/media/favicon.ico'
...
htmlhelp_basename = 'hichipper-docs'
...
latex_documents = [
  ('index', 'hichipper.tex', u'hichipper Documentation',
...
man_pages = [
    ('index', 'hichipper', u'hichipper Documentation',
     [u'Caleb Lareau'], 1)
]
...
texinfo_documents = [
  ('index', 'hichipper', u'hichipper Documentation',
   u'Caleb lareau', 'hichipper', 'Preprocessing HiChIP data',
   'Miscellaneous'),
]
...
epub_title = u'hichipper'
epub_author = u'Caleb Lareau'
epub_publisher = u'Caleb Lareau'
epub_copyright = u'Caleb Lareau, Aryee Lab'
