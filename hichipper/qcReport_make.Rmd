...
#### The first summary table notes how many PETs are in each sample and what fraction were mapped with high quality. The "% Long

```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width='\\textwidth'}
datatable(tab_summary2, class = 'cell-border stripe')
```

#### The table above shows 1) the total number of intrachromosomal PETs and 
